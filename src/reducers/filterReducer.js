  ...
  switch (action.type) {
    case RA.FILTER_EXACT_FIRM: {
      ...
      return Object.assign({}, state, {
        selectedSector: p.sector,
        selectedFirm: p.symbol,
        selectedSubIndustry: p.subIndustry
      });
    }
    case RA.FILTER_TICKER: {
      ...
      return Object.assign({}, state, {
        ...
        selectedFirm: t.symbol,
        selectedSubIndustry: t.subIndustry
      });
    }
    ...
    case RA.FILTER_SUBINDUSTRY:
      return Object.assign({}, state, {
        selectedSubIndustry: action.payload,
        selectedFirm: ''
      });
